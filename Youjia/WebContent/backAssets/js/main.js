		...
		function createCountDown(elem, end) {
			$(elem).countdown(end, function(event) {
			  var $this = $(this).html(event.strftime(''
			    + '<div class="countdown-number"><span>%D</span><br>天</div> '
			    + '<div class="countdown-number"><span>%H</span><br>时</div> '
			    + '<div class="countdown-number"><span>%M</span><br>分</div> '
			    + '<div class="countdown-number"><span>%S</span><br>秒</div>'));
			});
		}
	  	/****************************************************
					Home 1 Slick
